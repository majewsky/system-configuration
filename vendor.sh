...
if [ $# -eq 0 ]; then
  ...
  for TARGET_DIR in art coredns gandi-automatic-dns mpv-mpris otf-raleway perl-mp3-tag prometheus prometheus-node-exporter ripit screen-message ttf-montserrat; do
    vendor "${TARGET_DIR}"
  done
else
